...
- **Base path**: `/aff-character-sheet/` (configured in `vite.config.ts`)
...
- All paths in `public/manifest.json` must use the base path prefix: `/aff-character-sheet/`

### Testing

After deployment, test these URLs (all should return 200):
- `https://whalecancer.github.io/aff-character-sheet/manifest.json`
- `https://whalecancer.github.io/aff-character-sheet/`
- `https://whalecancer.github.io/aff-character-sheet/assets/index-*.js`
- `https://whalecancer.github.io/aff-character-sheet/assets/index-*.css`
- `https://whalecancer.github.io/aff-character-sheet/icon.svg`
...
1. Verify `vite.config.ts` has correct `base` path: `/aff-character-sheet/`
